...
<!-- badges: start -->
[![R build status](https://github.com/ropensci-review-tools/calcurseR/workflows/R-CMD-check/badge.svg)](https://github.com/ropensci-review-tools/calcurseR/actions?query=workflow%3AR-CMD-check)
