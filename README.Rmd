...
<!-- badges: start -->
[![R build status](https://github.com/mpadge/calcurseR/workflows/R-CMD-check/badge.svg)](https://github.com/mpadge/calcurseR/actions?query=workflow%3AR-CMD-check)
